...
SEARCH_RESULTS_NONEXISTS    = 4001
COUNT_INCREASE_ERROR        = 4002

# error codes for tests
TEST_NONEXISTS              = 5001
GET_TEST_INFO_ERROR         = 5002
CHANGE_TEST_INFO_ERROR      = 5003
ADD_TEST_INFO_ERROR         = 5004
DELETE_TEST_INFO_ERROR      = 5005

# other error codes
DB_CONNECTION_ERROR         = 6001
REQUEST_DATA_FORMAT_ERROR   = 6002
MISSING_REQUIRED_PARAMS     = 6003
SEND_VERIFY_CODE_ERROR      = 6004
FILE_TOO_LARGE              = 6005
REQUEST_DATA_ERROR          = 6006
...
CODE_STR = {
  ...
  #error codes for search
  SEARCH_RESULTS_NONEXISTS    : "搜索结果不存在",
  COUNT_INCREASE_ERROR        : "搜索次数增加失败",
